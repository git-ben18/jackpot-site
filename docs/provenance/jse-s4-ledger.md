...
| `src/app/page.tsx` | S2 scaffold + S4-B | REIMPLEMENT (DOI mount) | `src/app/page.tsx` | adapted | Mounts DOI hero; no `LandingDashboardClient` | `newsletter-doi-ui.test.ts` | dashboard |
