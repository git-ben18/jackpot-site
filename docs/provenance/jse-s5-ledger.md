...
| `src/components/shell/ConsentMountSeam.tsx` | CookieBanner (not copied) | n/a | REIMPLEMENT if retained | empty seam only | Hidden empty mount for S5-D; no banner | same | cookie_consent, decorative banner |
