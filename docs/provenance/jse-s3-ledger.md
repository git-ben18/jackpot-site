...
|---|---|
| Slice | `JSE-S3` |
| Status | S3-G complete — curated discovery mounted on `/` via `api.v_curated_promo_discovery`; S3-H closeout remains |
