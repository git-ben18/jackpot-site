...
This is **not** hosted OIDC acceptance, public DOI enablement, or production-authority transfer. Homepage composition mounts `InlineNewsletterHero` beside S3 curated discovery.
