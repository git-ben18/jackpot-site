...
**Current disposition (2026-09-10):** S3-F is [`ACCEPTED`](./_status-S3-F.md). S3-G homepage mount is repaired onto current `main` after S4: `/` renders DOI hero + curated discovery. S3-H closeout evidence is recorded ([`_status-S3-H.md`](./_status-S3-H.md)).
...
| S3-G | [S3-G-live-homepage-integration.md](./S3-G-live-homepage-integration.md) | Live homepage | S3-F `accepted` | Code — **complete** ([`_status-S3-G.md`](./_status-S3-G.md)); repaired after S4-H so DOI hero remains mounted |
| S3-H | [S3-H-evidence-closeout.md](./S3-H-evidence-closeout.md) | Closeout | S3-G | Docs / evidence — **complete** ([`_status-S3-H.md`](./_status-S3-H.md)) |
